...
if ($argc < 3) {
    die("
    Usage: php ./theme-creator.php [name] [output_dir|output_file] [-a author_name] [-u author_link] [-v version]
...
$output = $argv[2];
$author_name = "Yaro";
$author_link = "https://code.yaro.page/";
$version = "1.0";
...
$theme_name = 'theme_' . preg_replace('/^theme[\_]*/i', '', $name);
$Name = ucwords($name);
